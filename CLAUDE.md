...
| `docs-site/static/api-reference.html` | **Deployed copy** — served at `{docs-url}/api-reference.html` via Vercel _(moved from GitHub Pages, Session 108)_ |
| `docs-site/static/card-api-reference.html` | **Deployed copy** — served at `{docs-url}/card-api-reference.html` via Vercel _(Session 108)_ |
