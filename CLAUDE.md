...
| **Last git commit** | `09dc9d0` | Session 100 — fraud & risk management (Module 10) |
...
| **Last git commit** | `23038cf` | Session 101 — modal UI fixes for fraud admin pages |
...
| `docs/card-api-reference.html` | card-service API reference — 17 module sections, 50+ endpoints, same Nubeero styling as api-reference.html _(Session 44)_ |
